{
    init: function(elevators, floors) {
        ...
        // Initialises the arrays representing the number of passengers waiting at each floor and the direction they are traveling.
        var upWaiting = [];
        var downWaiting = [];
        ...
        /**
        * Assigns the listeners to the a general elevator.
        * @param {elevator} elevator The elevator to add the listeners too.
        * @param {number} hub The id for the elevator.
        */
        ...
        * @param {floor} floor The floor to add the listeners too.
        */
